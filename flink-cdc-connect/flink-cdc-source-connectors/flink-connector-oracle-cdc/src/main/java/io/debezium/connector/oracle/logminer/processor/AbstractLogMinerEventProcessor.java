 ...
 * extend.
 *
 * <p>Diff: pass the rowId ({@code dmlEvent.getRowId()}) to {@link LogMinerChangeRecordEmitter} so
 * the rowId is propagated as a Connect header on the emitted change records.
 *
