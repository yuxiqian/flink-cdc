 ...
 *
 * <p>This class overrides the emit methods to put some values in the header. Subclasses may
 * override {@link #getEmitConnectHeaders()} to attach extra Connect headers to every emitted
 * record.
 */
