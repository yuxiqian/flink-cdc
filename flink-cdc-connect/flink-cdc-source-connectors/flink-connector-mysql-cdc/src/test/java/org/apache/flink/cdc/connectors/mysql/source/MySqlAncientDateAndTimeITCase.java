    ...
    public void testAncientDateAndTimeWithTimeAdjuster() throws Exception {
        runGenericAncientDateAndTimeTest(
                ...
                Arrays.asList(
                        ...
                        "+I[2, 0, 1970-01-01T00:00, 1970-01-01T00:00, 1970-01-01T00:00, 1970-01-01T00:00, 1970-01-01T00:02:10.560, 1970-01-01T00:02:10.560, 1970-01-01T00:02:10.560]",
                        ...
                        row ->
                                RowUtils.createRowWithNamedPositions(
                                                ...
                                                new Object[] {
                                                    ...
                                                    row.getTimestamp(3, 1),
                                                    row.getTimestamp(4, 2),
                                                    row.getTimestamp(5, 3),
                                                    row.getTimestamp(6, 4),
                                                    row.getTimestamp(7, 5),
                                                    row.getTimestamp(8, 6)
                                                },
                                                map)
                                        .toString())
