...
public class JdbcSourceEventDispatcher<P extends Partition> extends EventDispatcher<P, TableId>
    ...
    public JdbcSourceEventDispatcher(
        ...
        // Debezium 2.7.4 replaced TopicSelector with TopicNamingStrategy; the schema-change topic
        // (previously TopicSelector#getPrimaryTopic) is now exposed via #schemaChangeTopic().
    ...
    public void dispatchSchemaChangeEvent(
        ...
        if (incrementalEventSource != null) {
            // Debezium 2.7.4 added the OffsetContext parameter to
